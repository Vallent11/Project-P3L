...
import com.example.gofit.ui.activity.izin.IzinActivity

class JadwalIzinAdapter (private val listJadwal : ArrayList<JadwalEntity>) : ListAdapter<JadwalEntity, JadwalIzinAdapter.ViewHolder>(DIFF_CALLBACK) {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            val intentToBooking = Intent(holder.itemView.context, IzinActivity::class.java)
